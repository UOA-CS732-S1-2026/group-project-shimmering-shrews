...
function BottomNav() {
  return (
    <nav className="bottom-nav" aria-label="Bottom navigation">
      <Link className="bottom-nav__item" to="/#map" aria-label="Map">
      ...
      <Link className="bottom-nav__item bottom-nav__item--active" to="/profile" aria-label="Profile" aria-current="page">
        <svg viewBox="0 0 24 24" aria-hidden="true">
